...
public class OtsuBinarize {
	...
	private static final Logger logger = Logger.getLogger(OtsuBinarize.class);
	private static BufferedImage original, grayscale, binarized;

	public static void main(String[] args) throws IOException {

		File original_f = new File(
				"/home/prasanna/Documents/OCR-Gimp/TestImage.jpg");
	...
	public static BufferedImage binarize(BufferedImage original) {
		...
		System.out.println("========================>>>> OTSU Threshold value :"
				+ threshold);
