...
@property (strong, nonatomic) UIImageView *failedImageUploadIcon;
@property (strong, nonatomic)  MAImagePickerControllerAdjustViewController *adjustViewController;

// View that adjust Image in background after click.
...
@property (assign,nonatomic) BOOL isUploadingDone;
